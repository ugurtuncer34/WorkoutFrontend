...
const Logger = () => {
    ...
    const weightOptions = [5, 8, 10, 12, 15, 20, 25];
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 flex flex-col transition-colors">
            <div className="max-w-md w-full mx-auto pt-6 flex-1 flex flex-col">
                ...
                <div className="bg-blue-50/30 dark:bg-blue-950/20 p-6 rounded-3xl shadow-sm border-2 border-blue-100/50 dark:border-blue-900/30 mb-6 flex-1 flex flex-col transition-colors">
                ...
                <button onClick={() => navigate(-1)} className="w-full bg-blue-50/50 dark:bg-blue-950/30 text-blue-700 dark:text-blue-300 border-2 border-blue-400/50 dark:border-blue-500/50 font-bold py-4 rounded-xl mt-auto shadow-[0_0_15px_rgba(37,99,235,0.15)] outline-none transition-all active:bg-blue-100 dark:active:bg-blue-900/60">
                    Complete Exercise
                </button>
            </div>
        </div>
